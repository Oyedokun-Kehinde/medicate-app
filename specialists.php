...
<body>
                        ...
                        <div class="pq-portfoliobox pq-style-1">
                           <div class="pq-portfolio-block">
                              ...
                              <div class="pq-portfolio-info">
                                 ...
                                 <h5><a href="case-studies.php">Home Visit</a></h5> </div>
                           </div>
                        </div>
                     </div>
                     <div class="item">
   ...
   <section class="about pq-pb-210">
      <div class="container">
         ...
         <div class="col-lg-12">
            <div class="pq-tabs-1">
               <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist"> <a class="pq-tabs nav-item nav-link active" id="nav-home-0" data-bs-toggle="tab" href="#nav-0" role="tab" aria-controls="nav-home-0" aria-selected="true"><i class=" flaticon-medical-doctor"></i><span>Angioplasty</span></a> <a class="pq-tabs nav-item nav-link " id="nav-home-1" data-bs-toggle="tab" href="#nav-1" role="tab" aria-controls="nav-home-1" aria-selected="true"><i class=" flaticon-doctor"></i><span>Neurology</span></a> <a class="pq-tabs nav-item nav-link " id="nav-home-2" data-bs-toggle="tab" href="#nav-2" role="tab" aria-controls="nav-home-2" aria-selected="true"><i class=" flaticon-care"></i><span>Eye Care</span></a> <a class="pq-tabs nav-item nav-link " id="nav-home-3" data-bs-toggle="tab" href="#nav-3" role="tab" aria-controls="nav-home-3" aria-selected="true"><i class=" flaticon-examination"></i><span>Cardiology</span></a> <a class="pq-tabs nav-item nav-link " id="nav-home-4" data-bs-toggle="tab" href="#nav-4" role="tab" aria-controls="nav-home-4" aria-selected="true"><i class=" flaticon-doctor-1"></i><span>Orthopaedics</span></a> </div>
               <div class="tab-content text-" id="nav-tabContent">
                  <div class="tab-pane fade show  active" id="nav-0" role="tabpanel" aria-labelledby="nav-home-0">
                     <div class="row align-items-center">
                        <div class="col-lg-6"> <img src="assets/images/tab/1.jpg" class="pq-full-width img-fluid" alt="seo-image"> </div>
                        <div class="col-lg-6">
                  ...
                  <div class="tab-pane fade show  " id="nav-1" role="tabpanel" aria-labelledby="nav-home-1">
                     <div class="row flex-row-reverse align-items-center">
                        <div class="col-lg-6"> <img src="assets/images/tab/2.jpg" class="pq-full-width img-fluid" alt="seo-image"> </div>
                        <div class="col-lg-6">
                           <div class="pq-tab-info">
                  ...
                  <div class="tab-pane fade show  " id="nav-2" role="tabpanel" aria-labelledby="nav-home-2">
                     <div class="row align-items-center">
                        <div class="col-lg-6"> <img src="assets/images/tab/3.jpg" class="pq-full-width img-fluid" alt="seo-image"> </div>
                        <div class="col-lg-6">
                           <div class="pq-tab-info">
                  ...
                  <div class="tab-pane fade show  " id="nav-3" role="tabpanel" aria-labelledby="nav-home-3">
                     <div class="row flex-row-reverse align-items-center">
                        <div class="col-lg-6"> <img src="assets/images/tab/4.jpg" class="pq-full-width img-fluid" alt="seo-image"> </div>
                        <div class="col-lg-6">
                           <div class="pq-tab-info">
                  ...
                  <div class="tab-pane fade show  " id="nav-4" role="tabpanel" aria-labelledby="nav-home-4">
                     <div class="row align-items-center">
                        <div class="col-lg-6"> <img src="assets/images/tab/5.jpg" class="pq-full-width img-fluid" alt="seo-image"> </div>
                        <div class="col-lg-6">
                           <div class="pq-tab-info">
