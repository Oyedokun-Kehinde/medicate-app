            ...
            <div class="register-wrapper">
                <div class="register-card">
                    ...
                    <div class="alert alert-success">
                        <i class="fas fa-check-circle"></i> Email verified successfully! Please login with your credentials.
                    </div>
                    <?php endif; ?>

                    <?php if (isset($_GET['registered'])): ?>
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle"></i> Please check your email and verify your account before logging in.
                    </div>
                    <?php endif; ?>
    ...
    <script>
        window.showSnackbar = function(message, type = 'info') {
            ...
            if (type === 'success') {
                ...
                snackbar.style.backgroundColor = '#f39c12';
                snackbar.style.color = '#fff';
            } else {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        if (data.require_verification) {
                            window.showSnackbar(data.message, 'warning');
                            
                            // Redirect to verification page if token exists
                            if (!data.token_expired) {
                                setTimeout(() => {
                                    window.location.href = 'verify-email.php?email=' + encodeURIComponent(data.email);
                                }, 2000);
                            } else {
                                // Redirect to resend OTP page
                                setTimeout(() => {
                                    window.location.href = 'resend-otp.php?email=' + encodeURIComponent(data.email);
                                }, 2000);
                            }
                        } else {
