...
<head>
   ...
   <title> {Blog Title} - Medicate </title>
         ...
         <div class="row">
            <div class="col-xl-8 col-lg-8 col-md-12">
               <div class="pq-blog-post">
                  <div class="pq-post-media"> <img src="images/blog/1.jpg" class="img-fluid" alt="medicate">
                  ...
                  <div class="pq-blog-contain">
                     ...
                     <p> It is a long established fact that a reader will be distracted by the readable content of a
                        page when looking at its layout. Lorem Ipsum is simply dummy text of the printing and
                     ...
                     <p> Medicate is a long established fact that a reader will be distracted by the readable content of
                        a page when looking at its layout. Lorem Ipsum is simply dummy text of the printing and
                        typesetting industry. Lorem Ipsum has been the industry’s standard dummy text ever since. Lorem
                        Ipsum is simply dummy text of the printing and typesetting industry. </p>
                     <div class="row mt-4">
                        <div class="col-lg-6 col-md-6">
                           <div class="blog-img text-center"> <img src="images/blog/single-blog-1.jpg" title="12"
                                 class="img-fluid" alt="blogimage"> </div>
                        </div>
                        <div class="col-lg-6 col-md-6 mt-lg-0 mt-md-0 mt-4">
                           <div class="blog-img text-center"> <img src="images/blog/single-blog-2.jpg" title="4"
                                 class="img-fluid" alt="blogimage"> </div>
                        </div>
                     </div>
                     <p class="mt-4"> Reader distracted by the readable content of a page when looking at its layout.
                     ...
                     <div class="pq-text-editor pq-clearfix"> There are many variations of passages of Lorem Ipsum
                     ...
                     <div class="pq-wrapper pq-fit-aspect-ratio">
                        <iframe class="pq-video"
                           ...
                           src="https://www.youtube.com/embed/XHOmBV4js_E?controls=1&amp;rel=0&amp;playsinline=0&amp;modestbranding=0&amp;autoplay=0&amp;widget_referrer=https%3A%2F%2Fmedicate.medicate.com%2Fhome-3%2F&amp;enablejsapi=1&amp;origin=https%3A%2F%2Fmedicate.medicate.com&amp;widgetid=1"
                           id="widget2"></iframe>
                     </div>
                  </div>
               </div>
               <div id="comments" class="pq-comment-area">
                        ...
                        <ol class="children">
                           <li class="comment byuser comment-author-Medicate Admin bypostauthor odd alt depth-2">
                              <div class="comment-body">
                                 <div class="pq-comment-info">
                                    <div class="pq-comment-wrap">
                                       <div class="pq-comment-avatar"> <img src="images/blog/user.png" class="" alt="">
                                       </div>
                                       <div class="pq-comment-box">
                                          <h5 class="title">
                                             <a href="index-2.html" rel="external nofollow ugc" class="url">Medicate
                                                Admin</a>
                                          </h5>
                                          <div class="pq-comment-metadata"> </div>
                                          <!-- .comment-metadata -->
                                       ...
                                       <!-- .comment-author -->
                                       <div class="reply"> <a rel="nofollow" class="comment-reply-link" href="#"
                                             data-commentid="3" data-postid="7401" data-belowelement="div-comment-3"
                                             data-respondelement="respond" data-replyto="Reply to Medicate Admin"
                                             aria-label="Reply to Medicate Admin">Reply</a> </div>
                                       <!-- .reply -->
                                    </div>
                                 </div>
                              </div>
                  ...
                  <div class="comment-respond">
                     ...
                     <form method="post" class="comment-form pq-applyform" novalidate>
                        ...
                        <div class="row">
                           <div class="col-lg-4">
                              <input id="author" class="name-field" name="author" type="text" placeholder=" Enter Name"
                                 required>
                           </div>
                           <div class="col-lg-4">
            ...
            <div class="col-lg-4 mt-lg-0 mt-5">
               <div class="Sidebar-style-2">
                  <div class="pq-widget widget_block pq-widget_search">
                     <form role="search" method="get" action="#"
                        ...
                        <div class="pq-block-search__inside-wrapper ">
                           <input type="search" id="pq-block-search__input-1" class="pq-block-search__input mb-0 "
                  ...
                  <div class="pq-widget pq-widget_media_image">
                     <div class="pq-block-group">
                        <div class="pq-block-group__inner-container">
                           <figure class="pq-block-image size-full is-style-default"><img src="images/call-img.jpg"
                  ...
                  <div class="pq-widget pq-widget_block">
                     <div class="pq-button-block">
                        <a href="index-2.html" class="pq-button pq-button-flat"> <span class="text">Download Now</span>
                        </a>
                     </div>
                  </div>
               </div>
