...
<body>
  ...
  header start-->
                                                ...
                                                <div id="pq-menu-contain" class="pq-menu-contain">
                                                      <ul id="pq-main-menu" class="navbar-nav ml-auto">
                                                            ...
                                                            <li class="menu-item">
                                                                  ...
                                                                  <ul class="sub-menu">
                                                                        <li class="menu-item ">
                                                                              <a href="services/angioplasty.php">Angioplasty
                                                                              </a>
                                                                        </li>
                                                                        <li class="menu-item ">
                                                                              <a
                                                                                    href="services/cardiology.php">Cardiology</a>
                                                                        </li>
                                                                        <li class="menu-item ">
                                                                        ...
                                                                        <li class="menu-item">
                                                                              <a
                                                                                    href="services/endocrinology.php">Endocrinology</a>
                                                                        </li>
                                                                        <li class="menu-item ">
                                                                              <a href="services/eye-care.php">Eye Care
                                                                              </a>
                                                                        </li>
                                                                        <li class="menu-item ">
                                                                              <a href="services/neurology.php">Neurology
                                                                              </a>
                                                                        </li>
                                                                        <li class="menu-item ">
                                                                              <a href="services/orthopaedics.php">Orthopaedics
                                                                              </a>
                                                                        </li>
                                                                        <li class="menu-item">
      ...
      <div class="appoinment-form  appointment-page pq-pt-130 pb-0">
            <div class="container">
                  <div class="row">
                              ...
                              <div class="appoinment-box">
                                    <form action="#" class="pq-applyform" novalidate>
                                          <div class="pq-appointment">
                                                <div class="row">
                                                      <div class="col-lg-12">
                                                            <label> <span class="pq-appointment-title"> Select
                                                                        Department </span> <span
                                                                        class="form-control-wrap your-country">
                                                                        <select name="your-country" class="form-select"
                                                                              aria-invalid="false">
                                                                              <option value="Gynaecology">Gynaecology
                                                                              </option>
                                                                              <option value="Cardiology">Cardiology
                                                                              </option>
                                                                              <option value="Orthopaedics">Orthopaedics
                                                                              </option>
                                                      ...
                                                      <div class="col-lg-12">
                                                            <label> <span class="pq-appointment-title"> Choose Doctor by
                                                                        Name </span> <span
                                                                        class="form-control-wrap your-country">
                                                                        <select name="your-country" class="form-select"
                                                                              aria-invalid="false">
                                                                              <option value="Naidan Smith">Naidan Smith
                                                                              </option>
                                                                              <option value="Danial Frankie">Danial
                                                                                    Frankie</option>
                                                                              <option value="Jason Roy">Jason Roy
                                                                              </option>
                                                                              <option value="Alexa Jhon">Alexa Jhon
                                                                              </option>
                                                                        </select>
                                                                  </span> </label>
                                                      </div>
                                                      <div class="col-lg-12">
                                                            <input type="text" id="patient-name" name="Patient"
                                                                  class="form-control pq-bg-white paitent-name-field"
                                                                  placeholder="Patient Name" required>
                                                      </div>
                                                      <div class="col-lg-6">
                                                            <input type="text" id="phone-number" name="Phone"
                                                                  class="form-control pq-bg-white phone-number-field"
                                                                  aria-invalid="false" placeholder="Phone" required>
                                                      </div>
                                                      <div class="col-lg-6">
                                                            <input type="email" id="e-mail" name="your-email"
                                                                  class="form-control pq-bg-white e-mail-field"
                                                      ...
                                                      <div class="col-lg-6">
                                                            <input type="text" id="time" name="Time"
                                                                  class="form-control pq-bg-white time-field"
                                                                  aria-invalid="false" placeholder="time"> </span>
                                                      </div>
                                                      <div class="col-lg-12">
                                                            <textarea cols="40" id="message" rows="10"
                                                                  aria-invalid="false" class="form-control pq-bg-white"
                                                                  placeholder="Type Appintment Note"></textarea>
                                                      </div>
                                                      <div class="col-lg-12">
                        ...
                        <div class="col-xl-6">
                              <div class="appointment-img text-center"> <img src="assets/images/appoinment.png" alt=""
      ...
      <section class="contact-us pq-bg-primary-dark pq-bg-img-1">
            <div class="container">
                  <div class="row ">
                        ...
                        <div
                              class="col-xl-5 d-xl-flex justify-content-xl-end align-items-center text-left mt-xl-0 mt-4">
                              <a class="pq-button pq-button-flat" href="contact.php">
                                    <div class="pq-button-block"> <span class="pq-button-text">Contact Us</span> <i
      ...
      <!--=================================
      testimonial start -->
      <section class="testimonial pq-bg-grey pq-testimonial-whitebg">
            <div class="container">
                  <div class="row">
                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-12 ">
                              <div class="owl-carousel owl-theme" data-dots="true" data-nav="false" data-desk_num="2"
                                    data-lap_num="2" data-tab_num="1" data-mob_num="1" data-mob_sm="1"
                                    ...
                                    <div class="item">
                                          <div class=" pq-testimonial-box pq-style-1 ">
                                                <div class="pq-testimonial-info">
                                                      <div class="pq-testimonial-content">
                                                            <p>There are many variations of passages of Lorem Ipsum
                                                                  ...
                                                                  which don’t look even believable. There are many
                                                ...
                                                <div class="pq-testimonial-media">
                                                      ...
                                                      <div class="pq-testimonial-icon"> <i
                  ...
                  <div class="row">
                        ...
                        <div class="col-lg-12">
                              <div class="owl-carousel owl-theme" data-dots="false" data-nav="false" data-desk_num="3"
                                    data-lap_num="3" data-tab_num="2" data-mob_num="1" data-mob_sm="1"
                                    data-autoplay="true" data-loop="true" data-margin="30">
                                    <div class="item">
                                          <div class="pq-blog-post pq-style-1 pq-bg-grey">
                                                <div class="pq-post-media"> <img src="assets/images/blog/1.jpg"
                                                ...
                                                <div class="pq-blog-contain">
                                                      <div class="pq-post-meta">
                                                            <ul>
                                                                  <li class="pq-post-author"><i
                                                                              class="fa fa-user"></i>Medicate Admin</li>
                                                      ...
                                                      <a href="blog-single.php" class="pq-button pq-button-link">
                                                            <div class="pq-button-block"> <span
                                                                        class="pq-button-text">Read More</span> <i
                                                                        class="ion ion-plus-round"></i> </div>
                                                      </a>
                                                </div>
                                          </div>
                                    ...
                                    <div class="item">
                                          <div class="pq-blog-post pq-style-1 pq-bg-grey">
                                                <div class="pq-post-media"> <img src="assets/images/blog/2.jpg"
                                                            class="img-fluid" alt="images">
                                                      <div class="pq-post-date">
                                                            <a href="blog-single.php"> <span>December 5, 2021</span></a>
                                                      </div>
                                    ...
                                    <div class="item">
                                          <div class="pq-blog-post pq-style-1 pq-bg-grey">
                                                <div class="pq-post-media"> <img src="assets/images/blog/3.jpg"
                                                            class="img-fluid" alt="images">
                                                      <div class="pq-post-date">
                                                            <a href="blog-single.php"> <span>December 5, 2021</span></a>
                                                      </div>
                                                ...
                                                <div class="pq-blog-contain">
                                                      ...
                                                      <h5 class="pq-blog-title"><a href="blog-single.php">Latest
                                                                  Equipment for the Heart Treatment</a></h5>
                                                      <div class="pq-blog-info">
                                                            <p>It is a long established fact that a reader will be
                                                                  distracted by the readable content of a page when
                                                                  looking at its layout.</p>
                                    ...
                                    <div class="item">
                                          <div class="pq-blog-post pq-style-1 pq-bg-grey">
                                                <div class="pq-post-media"> <img src="assets/images/blog/4.jpg"
                                                            class="img-fluid" alt="images">
                                                      <div class="pq-post-date">
                                                            <a href="blog-single.php"> <span>December 5, 2021</span></a>
                                                      </div>
                                                ...
                                                <div class="pq-blog-contain">
                                                      ...
                                                      <h5 class="pq-blog-title"><a href="blog-single.php">What is Future
                                                                  of Blood Pressure Monitoring?</a></h5>
                                                      <div class="pq-blog-info">
                                                            <p>It is a long established fact that a reader will be
                                                                  distracted by the readable content of a page when
                                                                  looking at its layout.</p>
                                    ...
                                    <div class="item">
                                          <div class="pq-blog-post pq-style-1 pq-bg-grey">
                                                <div class="pq-post-media"> <img src="assets/images/blog/5.jpg"
                                                            class="img-fluid" alt="images">
                                                      <div class="pq-post-date">
                                                            <a href="blog-single.php"> <span>December 5, 2021</span></a>
                                                      </div>
                                                ...
                                                <div class="pq-blog-contain">
                                                      ...
                                                      <h5 class="pq-blog-title"><a href="blog-single.php">Goals Setting
                                                                  the people Heart is Healthy</a></h5>
                                                      <div class="pq-blog-info">
                                                            <p>It is a long established fact that a reader will be
                                                                  distracted by the readable content of a page when
                                                                  looking at its layout.</p>
                                    ...
                                    <div class="item">
                                          <div class="pq-blog-post pq-style-1 pq-bg-grey">
                                                <div class="pq-post-media"> <img src="assets/images/blog/6.jpg"
                                                            class="img-fluid" alt="images">
                                                      <div class="pq-post-date">
                                                            <a href="blog-single.php"> <span>December 5, 2021</span></a>
                                                      </div>
                                                ...
                                                <div class="pq-blog-contain">
                                                      ...
                                                      <h5 class="pq-blog-title"><a href="blog-single.php">For
                                                                  Examination of kids get Special offers</a></h5>
                                                      <div class="pq-blog-info">
                                                            <p>It is a long established fact that a reader will be
                                                                  distracted by the readable content of a page when
                                                                  looking at its layout.</p>
                                    ...
                                    <div class="item">
                                          <div class="pq-blog-post pq-style-1 pq-bg-grey">
                                                <div class="pq-post-media"> <img src="assets/images/blog/7.jpg"
                                                            class="img-fluid" alt="images">
                                                      <div class="pq-post-date">
                                                            <a href="blog-single.php"> <span>December 5, 2021</span></a>
                                                      </div>
                                                ...
                                                <div class="pq-blog-contain">
                                                      ...
                                                      <h5 class="pq-blog-title"><a href="blog-single.php">Heart Failure
                                    ...
                                    <div class="item">
                                          <div class="pq-blog-post pq-style-1 pq-bg-grey">
                                                <div class="pq-post-media"> <img src="assets/images/blog/8.jpg"
                                                            class="img-fluid" alt="images">
                                                      <div class="pq-post-date">
                                                            <a href="blog-single.php"> <span>December 5, 2021</span></a>
                                                      </div>
                                                ...
                                                <div class="pq-blog-contain">
                                                      ...
                                                      <h5 class="pq-blog-title"><a href="blog-single.php">Hard content
                                                                  we decide ourselves a intently</a></h5>
                                                      <div class="pq-blog-info">
                                                            <p>It is a long established fact that a reader will be
                                                                  distracted by the readable content of a page when
                                                                  looking at its layout.</p>
                                    ...
                                    <div class="item">
                                          <div class="pq-blog-post pq-style-1 pq-bg-grey">
                                                <div class="pq-post-media"> <img src="assets/images/blog/9.jpg"
                                                            class="img-fluid" alt="images">
                                                      <div class="pq-post-date">
                                                            <a href="blog-single.php"> <span>December 5, 2021</span></a>
                                                      </div>
                                                ...
                                                <div class="pq-blog-contain">
                                                      ...
                                                      <h5 class="pq-blog-title"><a href="blog-single.php">Is Running
                                                                  Really Good for the Heart?</a></h5>
                                                      <div class="pq-blog-info">
                                                            <p>It is a long established fact that a reader will be
                                                                  distracted by the readable content of a page when
                                                                  looking at its layout.</p>
                              ...
                              <div class="row align-items-center">
                                    <div class="col-lg-12">
                                          <div class="pq-subscribe-bg">
                                                <div class="row align-items-center">
                                                      <div class="col-lg-5">
                                                            <div class="pq-subscribe-block"> <img
                                                                        src="assets/images/Subscribe.png"
                                                                        class="pq-subscribe-img img-fluid"
                                                                        alt="medicate-subscribe-image">
                                                                  <div class="pq-subscribe-details">
                                                                        <h5>Latest Updates Subscribe To Our Newsletter
                                                                        </h5>
                                                                  </div>
                                                            </div>
                                                      </div>
                                                            ...
                                                            <div class="pq-subscribe-from">
                                                                  <form id="form" class="form">
                                                                        <div class="form-fields">
                                                                              <input class="w-100 pq-bg-transparent"
                              ...
                              <div class="row">
                                    <div class="col-xl-3 col-md-6">
                                          <div class="pq-footer-block"> <img src="assets/images/footer_logo.png"
                                                ...
                                                <p>It helps designers plan out where the content will sit, the content
                                                      to be written and
                                                      approved.</p>
                                    ...
                                    <div class="col-xl-3  col-md-6">
                                          <div class="pq-footer-block">
                                                ...
                                                <div class="pq-footer-recent-post">
                                                      <div class="pq-footer-recent-post-media">
                                                            <a href="blog-single.php"> <img
                                                                        src="assets/images/footer-image/2.jpg"
                                                                        alt=""></a>
                                                      </div>
                                                      <div class="pq-footer-recent-post-info">
                                                            <a href="blog-single.php" class="pq-post-date"> <i
                                                      ...
                                                      <div class="col-sm-12">
                                                            <ul class="pq-contact">
                                                                  ...
                                                                  <li> <i class="fas fa-map-marker"></i> <span>
                                                                              Medicate Lab, S5/808B, Oba Adesida Raod,
                                                                              Akure, Ondo State </span> </li>
                                                            </ul>
                                                      </div>
                                                </div>
                                          </div>
