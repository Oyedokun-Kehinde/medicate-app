...
<head>
    ...
    <title> FAQs – Hospital Management System </title>
...
<body>
   ...
   <section class="faq">
      <div class="container">
         <div class="row">
            <div class="col-xl-6"> <img src="assets/images/faq.jpg" class="img-fluid" alt=""> </div>
            <div class="col-xl-6 mt-xl-0 mt-5 ps-xl-3">
               <div class="pq-section pq-style-1 "> <span class="pq-section-sub-title">COMMON QUERIES</span>
                  <h5 class="pq-section-title">Asked Questions</h5>
               </div>
               <div class="pq-accordion-block mt-4">
                  <div class="pq-accordion-box 1">
                     ...
                     <div class="pq-accordion-details" style="display: none;">
                        <p class="pq-detail-text"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit
   ...
   <section class="testimonial pq-bg-grey">
      <div class="container">
         ...
         <div class="row">
            <div class="col-lg-2 pq-testimonial-images"> <img src="assets/images/testimonial/t3.png"
                  class="img-fluid testimonialimg1 img-fluid" alt="testimonial-image"> <img
                  src="assets/images/testimonial/t4.png" class="img-fluid testimonialimg2" alt="testimonial-image"> </div>
            <div class="col-lg-8 text-center">
               <div class="owl-carousel owl-theme" data-dots="true" data-nav="false" data-desk_num="1" data-lap_num="1"
                  data-tab_num="1" data-mob_num="1" data-mob_sm="1" data-autoplay="false" data-loop="false"
                  data-margin="30">
                  <div class="item">
                        ...
                        <div class="pq-testimonial-info">
                           <div class="pq-testimonial-content">
                              <p>There are many variations of passages of Lorem Ipsum available, but the majority have
                                 suffered alteration in someform, by injected humour, or randomised words which don’t
                                 look even believable.There are many variations of passages of It is a long established
            ...
            <div class="col-lg-2 pq-testimonial-images"> <img src="assets/images/testimonial/t2.png"
                  class="img-fluid  testimonialimg3" alt="testimonial-image"> <img src="assets/images/testimonial/t1.png"
                  class="img-fluid testimonialimg4 " alt="testimonial-image"> </div>
         </div>
      </div>
   </section>
   <!--=================================
         ...
         <div class="row">
            ...
            <div class="col-lg-12">
               <div class="owl-carousel owl-theme" data-dots="false" data-nav="false" data-desk_num="3" data-lap_num="3"
                  data-tab_num="2" data-mob_num="1" data-mob_sm="1" data-autoplay="false" data-loop="false"
                  data-margin="30">
                  <div class="item">
