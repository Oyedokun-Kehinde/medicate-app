   ...
   <section class="1-colume-grid pq-pb-210">
      <div class="container">
         <div class="row">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        <div class="pq-blog-post">
                           <div class="pq-post-media"> <img class="img-fluid" src="assets/images/blog/1.jpg"
                                 alt="blogimage">
                              <div class="pq-post-date">
                                 <a href="blog-single.php"> <span>December 17, 2021</span></a>
                              </div>
                           </div>
                           <div class="pq-blog-contain">
                              ...
                              <h5 class="pq-blog-title"><a href="blog-single.php">Get
                                    the Exercise Limited Mobility</a>
                              </h5>
                              <div class="pq-blog-info">
                                 <p>It is a long established fact that a reader will be distracted by the readable
                                    content of a page when looking at its layout. </p>
                              </div>
                              <a href="blog-single.php" class="pq-button pq-button-flat">
                     ...
                     <div class="col-lg-12">
                        <div class="pq-blog-post">
                           <div class="pq-post-media"> <img class="img-fluid" src="assets/images/blog/2.jpg"
                                 alt="blogimage">
                              <div class="pq-post-date">
                     ...
                     <div class="col-lg-12">
                        <div class="pq-blog-post">
                           <div class="pq-post-media"> <img class="img-fluid" src="assets/images/blog/3.jpg"
                                 alt="blogimage">
                              <div class="pq-post-date">
                                 <a href="blog-single.php"> <span>December 5, 2021</span></a>
                              </div>
                     ...
                     <div class="col-lg-12">
                        <div class="pq-blog-post">
                           <div class="pq-post-media"> <img class="img-fluid" src="assets/images/blog/4.jpg"
                                 alt="blogimage">
                              <div class="pq-post-date">
                                 <a href="blog-single.php"> <span>December 5, 2021</span></a>
                              </div>
                           ...
                           <div class="pq-blog-contain">
                              ...
                              <h5 class="pq-blog-title"><a href="blog-single.php">What
                                    is Future of Blood Pressure Monitoring?</a>
                              </h5>
                              <div class="pq-blog-info">
                                 <p>It is a long established fact that a reader will be distracted by the readable
                                    content of a page when looking at its layout. </p>
                     ...
                     <div class="col-lg-12">
                        <div class="pq-blog-post">
                           <div class="pq-post-media"> <img class="img-fluid" src="assets/images/blog/5.jpg"
                                 alt="blogimage">
                              <div class="pq-post-date">
                                 <a href="blog-single.php"> <span>December 5, 2021</span></a>
                              </div>
                     ...
                     <div class="col-lg-12">
                        <div class="pq-blog-post">
                           <div class="pq-post-media"> <img class="img-fluid" src="assets/images/blog/6.jpg"
                                 alt="blogimage">
                              <div class="pq-post-date">
                                 <a href="blog-single.php"> <span>December 5, 2021</span></a>
                              </div>
                     ...
                     <div class="col-lg-12">
                        <div class="pq-blog-post">
                           <div class="pq-post-media"> <img class="img-fluid" src="assets/images/blog/7.jpg"
                                 alt="blogimage">
                              <div class="pq-post-date">
                                 <a href="blog-single.php"> <span>December 5, 2021</span></a>
                              </div>
                     ...
                     <div class="col-lg-12">
                        <div class="pq-blog-post">
                           <div class="pq-post-media"> <img class="img-fluid" src="assets/images/blog/8.jpg"
                                 alt="blogimage">
                              <div class="pq-post-date">
                                 <a href="blog-single.php"> <span>December 5, 2021</span></a>
                              </div>
                     ...
                     <div class="col-lg-12">
                        <div class="pq-blog-post">
                           <div class="pq-post-media"> <img class="img-fluid" src="assets/images/blog/9.jpg"
                                 alt="blogimage">
                              <div class="pq-post-date">
                                 <a href="blog-single.php"> <span>October 18, 2021</span></a>
                              </div>
                           </div>
                           <div class="pq-blog-contain">
                              <div class="pq-post-meta">
            ...
            <div class="col-xl-4 ps-3 mt-xl-0">
               <div class="Sidebar">
                  <div class="pq-widget widget_block pq-widget_search">
                     <form role="search" method="get" action="#"
                        class="pq-block-search__button-outside pq-block-search__text-button pq-block-search">
                        <div class="pq-block-search__inside-wrapper ">
                           <input type="search" class="pq-block-search__input" name="s" value="" placeholder=""
                              required>
                  ...
                  <div class="pq-widget pq-widget_block">
                     <div class="pq-block-group">
                        <div class="pq-block-group__inner-container">
                           <h2>Tag</h2>
                           <p class="pq-block-tag-cloud"> <a href="#" class="tag-cloud-link "
                                 aria-label="Adventures">Adventures</a> <a href="#" class="tag-cloud-link "
                                 aria-label="Cardiac">Cardiac</a> <a href="#" class="tag-cloud-link"
                                 aria-label="Care">Care</a> <a href="#" class="tag-cloud-link"
                                 aria-label="Doctors">Doctors</a> <a href="#" class="tag-cloud-link"
                                 aria-label="Health">Health</a> <a href="#" class="tag-cloud-link"
                                 aria-label="Hospital">Hospital</a> </p>
                        </div>
                     </div>
                  </div>
                  <div class="pq-widget pq-widget_nav_menu">
                     ...
                     <div class="menu-service-menu-container">
                        <ul class="menu">
                           <li><a href="../public/services/angioplasty.php">Angioplasty Services</a></li>
                           <li><a href="../public/services/cardiology.php">Cardiology Services</a></li>
                           <li><a href="../public/services/dental.php">Dental Services</a></li>
                           <li><a href="../public/services/endocrinology.php">Endocrinology Services</a></li>
                           <li><a href="../public/services/eye-care.php">Eye Care Services</a></li>
                           <li><a href="../public/services/neurology.php">Neurology Services</a></li>
                           <li><a href="../public/services/orthopaedics.php">Orthopaedics Services</a></li>
                           <li><a href="../public/services/rmi.php">RMI Services</a></li>
                        </ul>
                     </div>
                  </div>
                     ...
                     <div class="pq-block-group">
                        <div class="pq-block-group__inner-container">
                           <figure class="pq-block-image size-full is-style-default"><img
                                 src="assets/images/call-img.jpg" alt="" class=""></figure>
                        </div>
                     </div>
                  </div>
                  <div class="pq-widget pq-widget_block">
                     <div class="pq-button-block">
                        <a href="contact.php" class="pq-button pq-button-flat"> <span class="text"> Contact Us </span>
                        </a>
                     </div>
                  </div>
               </div>
